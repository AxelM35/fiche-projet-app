...
Application web de gestion et de validation des voyages scolaires du Collège Exemple, en remplacement du workflow historique base sur Google Sheets.
...
```
src/main/java/fr/ficheprojet/voyages/
